          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-xs text-text-faint">Get notified when a new tenant applies</div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-xs text-text-faint">Get notified on agreement expiry or AI analysis completion</div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" defaultChecked className="sr-only peer" />
                <div className="w-11 h-6 bg-border peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-border after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-lease-600"></div>
        ...
        <div className="bg-white border border-border rounded-xl shadow-sm p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input type="password" placeholder="••••••••" className="w-full max-w-md px-3 py-2 bg-paper border border-border rounded-lg text-sm focus:outline-none focus:border-lease-500" />
            </div>
            <div>
