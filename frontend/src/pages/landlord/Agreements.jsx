    ...
    { 
      ...
      render: (row) => (
        <div className="flex items-center gap-2">
          ...
          <button className="p-1 text-text-muted hover:text-ink transition-colors" title="Download Document">
    ...
    <div className="space-y-6 fade-in pb-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-text-muted mt-1">Manage and analyze your active rental contracts.</p>
        </div>
