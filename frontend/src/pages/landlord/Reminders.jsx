    ...
    <div className="space-y-6 fade-in pb-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-text-muted mt-1">Manage important dates, deadlines, and property maintenance.</p>
        </div>
      ...
      <div className="bg-white border border-border rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="divide-y divide-border">
          {filteredData.length > 0 ? filteredData.map(rem => (
            <div key={rem.id} className="p-6 hover:bg-paper/30 transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-muted mt-1">{rem.property}</p>
              ...
              <div className="flex items-center gap-3 sm:pl-16">
                <button className="flex items-center gap-2 px-4 py-2 bg-paper border border-border text-ink rounded-lg text-sm font-medium hover:bg-border/50 transition-colors">
                  Edit
                </button>
