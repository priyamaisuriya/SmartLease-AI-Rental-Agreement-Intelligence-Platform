        ...
        <div className="w-full max-w-[400px] animate-in slide-in-from-bottom-4 duration-500 fade-in">
          ...
          <div className="flex items-center gap-6 mb-8 border-b border-border">
            ...
            >
              ...
              {isLogin && (
                <span className="absolute left-0 right-0 bottom-[-1px] h-[2px] bg-gold rounded-sm"></span>
              )}
            </button>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-3.5 py-2.5 pr-10 text-[14.5px] text-ink bg-white border border-border rounded-[3px] outline-none transition-all focus:border-gold focus:ring-[3px] focus:ring-gold/20 placeholder:text-text-faint"
