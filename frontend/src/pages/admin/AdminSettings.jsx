          ...
          <div className="bg-white border border-border rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="text" defaultValue="SmartLease AI" className="w-full px-3 py-2 bg-paper border border-border rounded-lg text-sm focus:outline-none focus:border-lease-500" />
              </div>
              <div>
                <label className="block text-sm font-medium text-text-muted mb-1">Contact Email</label>
                <input type="email" defaultValue="admin@smartlease.ai" className="w-full px-3 py-2 bg-paper border border-border rounded-lg text-sm focus:outline-none focus:border-lease-500" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-border rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <select className="w-full px-3 py-2 bg-paper border border-border rounded-lg text-sm focus:outline-none focus:border-lease-500">
          ...
          <div className="bg-white border border-border rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="number" defaultValue="60" className="w-full px-3 py-2 bg-paper border border-border rounded-lg text-sm focus:outline-none focus:border-lease-500" />
              </div>
              <div className="flex items-center justify-between">
                <div>
