      ...
      <div className="bg-surface rounded-xl shadow-sm border border-line overflow-hidden">
        ...
        <div className="px-6 sm:px-10 pb-8 relative">
          <div className="flex flex-col sm:flex-row gap-6 -mt-12 sm:-mt-16 mb-8">
            <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full border-4 border-surface bg-canvas flex items-center justify-center text-4xl font-bold text-ink flex-shrink-0">
              AD
            </div>
            <div className="pt-2 sm:pt-16 flex-1">
              ...
              <p className="text-ink-soft font-medium">Super Administrator</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <h3 className="font-semibold text-ink border-b border-line pb-2">Account Information</h3>
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3 text-sm">
                  <ShieldCheck className="w-5 h-5 text-ink-soft flex-shrink-0" />
                  <div>
                    <p className="text-ink-faint">Role & Permissions</p>
