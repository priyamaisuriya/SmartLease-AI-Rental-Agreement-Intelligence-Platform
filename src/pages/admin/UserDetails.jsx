  ...
  return (
    <div className="space-y-6 fade-in pb-8">
      ...
      <div className="flex items-center gap-4">
        <Link to="/admin/users" className="p-2 text-ink-soft hover:bg-surface rounded-lg border border-transparent hover:border-line transition-all">
        ...
        <div>
          ...
          <p className="text-ink-soft mt-1">Manage user account details and history.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-surface rounded-xl shadow-sm border border-line overflow-hidden">
            <div className="p-6 border-b border-line text-center">
              ...
              <div className="mt-4">
                <span className="px-3 py-1 bg-canvas text-ink-soft rounded-full text-xs font-medium border border-line">
                  {user.role}
                </span>
              </div>
            </div>
            <div className="p-6 space-y-4">
              <div className="flex justify-between text-sm">
                <span className="text-ink-soft">Joined Date</span>
              ...
              <div className="flex justify-between text-sm">
                <span className="text-ink-soft">Properties</span>
                <span className="font-medium text-ink">{user.properties}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-ink-soft">Agreements</span>
          ...
          <div className="bg-surface rounded-xl shadow-sm border border-line p-6">
            ...
            <div className="space-y-3">
              <button className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-canvas border border-line rounded-lg text-sm font-medium text-ink hover:bg-line/50 transition-colors">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-surface rounded-xl shadow-sm border border-line overflow-hidden">
            ...
            <div className="divide-y divide-line p-6 space-y-4">
              {recentActivity.slice(0, 4).map((activity, idx) => (
                <div key={idx} className="flex gap-4 pt-4 first:pt-0 relative">
                  {idx !== 3 && <div className="absolute left-5 top-10 bottom-0 w-px bg-line"></div>}
                  ...
                  <div className="pb-4">
                    ...
                    <p className="text-xs text-ink-soft mt-1">{activity.time}</p>
                  </div>
                </div>
              ))}
            </div>
