    ...
    <div className="space-y-6 fade-in pb-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-ink-soft mt-1">Monitor AI engine performance and feature utilization.</p>
        </div>
        <div className="flex items-center gap-2">
          <select 
            value={dateFilter}
            onChange={(e) => setDateFilter(e.target.value)}
            className="px-4 py-2 bg-surface border border-line rounded-lg text-sm font-medium text-ink focus:outline-none focus:ring-1 focus:ring-lease-500"
          >
