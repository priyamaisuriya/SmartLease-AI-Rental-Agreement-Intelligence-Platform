    ...
    { 
      ...
      render: (row) => (
        <div className="flex items-center gap-2">
          ...
          <button className="p-1 text-ink-soft hover:text-ink transition-colors" title="Archive">
    ...
    <div className="space-y-6 fade-in pb-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-ink-soft mt-1">Review feedback and ratings from platform users.</p>
        </div>
      </div>
