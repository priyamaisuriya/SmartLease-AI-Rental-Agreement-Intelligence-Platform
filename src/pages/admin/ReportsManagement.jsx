    ...
    { 
      ...
      render: (row) => (
        <div className="flex items-center gap-2">
          <button className="p-1 text-ink-soft hover:text-lease-600 transition-colors" title="View">
            <Eye className="w-4 h-4" />
          </button>
          <button className="p-1 text-ink-soft hover:text-lease-600 transition-colors" title="Download">
            <Download className="w-4 h-4" />
          </button>
          <button className="p-1 text-ink-soft hover:text-bad-600 transition-colors" title="Delete">
    ...
    <div className="space-y-6 fade-in pb-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-ink-soft mt-1">Monitor generated system and analysis reports.</p>
        </div>
      </div>
