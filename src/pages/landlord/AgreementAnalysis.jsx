    ...
    <div className="space-y-6 fade-in pb-12 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <Link to="/landlord/agreements" className="p-2 text-ink-soft hover:bg-surface rounded-lg border border-transparent hover:border-line transition-all">
          ...
          <div>
            ...
            <p className="text-ink-soft mt-1">AI-powered risk analysis for Sunset_Apt_Lease_2026.pdf</p>
          </div>
        </div>
        <div className="flex gap-2">
          ...
          <button className="flex items-center gap-2 px-4 py-2 bg-canvas border border-line rounded-lg text-sm font-medium text-ink hover:bg-line/50 transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-surface rounded-xl shadow-sm border border-line p-6 text-center">
          ...
          <div className="bg-surface rounded-xl shadow-sm border border-line p-6">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex justify-between border-b border-line pb-2">
                <span className="text-ink-soft">Property</span>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-surface rounded-xl shadow-sm border border-line overflow-hidden">
            ...
            <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <p className="text-sm text-ink-soft">Contractual Monthly Rent</p>
              ...
              <div>
                <p className="text-sm text-ink-soft">Security Deposit</p>
                <p className="text-xl font-bold text-ink mt-1">₹2,00,000</p>
              </div>
              <div>
                <p className="text-sm text-ink-soft">Maintenance</p>
                <p className="text-base font-semibold text-ink mt-1">Included in Rent</p>
              </div>
              <div>
                <p className="text-sm text-ink-soft">Late Payment Penalty</p>
          ...
          <div className="bg-surface rounded-xl shadow-sm border border-line p-6">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1.5 bg-canvas border border-line rounded-lg text-sm text-ink">Termination (Clause 9)</span>
              <span className="px-3 py-1.5 bg-canvas border border-line rounded-lg text-sm text-ink">Security Deposit (Clause 4)</span>
              <span className="px-3 py-1.5 bg-canvas border border-line rounded-lg text-sm text-ink">Rent Increase (Clause 3)</span>
              <span className="px-3 py-1.5 bg-canvas border border-line rounded-lg text-sm text-ink">Painting (Clause 11)</span>
            </div>
          </div>
        </div>
      </div>
