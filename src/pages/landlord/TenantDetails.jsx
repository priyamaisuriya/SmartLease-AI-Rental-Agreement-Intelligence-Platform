  ...
  return (
    <div className="space-y-6 fade-in pb-8">
      ...
      <div className="flex items-center gap-4">
        <Link to="/landlord/tenants" className="p-2 text-ink-soft hover:bg-surface rounded-lg border border-transparent hover:border-line transition-all">
        ...
        <div>
          ...
          <p className="text-ink-soft mt-1">Tenant Details & Rental History</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-surface rounded-xl shadow-sm border border-line p-6 text-center">
             ...
             <p className="text-ink-soft text-sm">Tenant since Jan 2026</p>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-surface rounded-xl shadow-sm border border-line p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                <p className="text-sm text-ink-soft">Contractual Rent</p>
              ...
              <div>
                <p className="text-sm text-ink-soft">Rental Start Date</p>
          ...
          <div className="bg-surface rounded-xl shadow-sm border border-line p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
              <div>
                <p className="text-sm text-ink-soft">Agreement Expiry</p>
                <p className="font-medium text-ink mt-1">Dec 31, 2026</p>
              </div>
              <div>
                <p className="text-sm text-ink-soft">Notice Period</p>
                <p className="font-medium text-ink mt-1">2 Months</p>
              </div>
              <div>
                <p className="text-sm text-ink-soft">Lock-in Period</p>
            ...
            <div className="flex gap-3">
              ...
              <button className="px-4 py-2 bg-canvas border border-line text-ink rounded-lg text-sm font-medium hover:bg-line/50 transition-colors">
                Download PDF
              </button>
            </div>
          </div>
