...
const ReportCard = ({ title, desc, icon: Icon, date }) => (
  <div className="bg-surface rounded-xl shadow-sm border border-line p-6 flex flex-col hover:shadow-md transition-shadow">
    ...
    <div className="mt-4 pt-4 border-t border-line flex items-center justify-between">
      <span className="text-xs text-ink-faint">Generated: {date}</span>
    ...
    <div className="space-y-6 fade-in pb-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-ink-soft mt-1">Export data on property occupancy, rental income, and agreements.</p>
        </div>
      </div>
