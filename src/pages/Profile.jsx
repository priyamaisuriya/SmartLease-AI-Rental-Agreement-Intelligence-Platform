...
const Profile = () => {
  ...
  return (
    <div className="fade-in">
      ...
      <p className="mt-1 text-sm text-ink-soft">Manage your account details and preferences.</p>
      ...
      <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="space-y-6 lg:col-span-2">
          ...
          <div className="rounded-xl2 border border-line bg-surface p-6">
            ...
            <div className="mt-5 flex items-center gap-4">
              ...
              <button className="rounded-lg border border-line px-3 py-2 text-xs font-medium text-ink hover:bg-canvas">Change photo</button>
            </div>
            <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                <label className="text-xs font-medium text-ink-soft">Full name</label>
                <input defaultValue="Ananya Rao" className="mt-1.5 w-full rounded-lg border border-line px-3 py-2.5 text-sm text-ink focus:outline-none" />
              </div>
              <div>
                <label className="text-xs font-medium text-ink-soft">Email</label>
                <input defaultValue="ananya.rao@example.com" className="mt-1.5 w-full rounded-lg border border-line px-3 py-2.5 text-sm text-ink focus:outline-none" />
              </div>
              <div>
                <label className="text-xs font-medium text-ink-soft">Phone</label>
                <input defaultValue="+91 98765 43210" className="mt-1.5 w-full rounded-lg border border-line px-3 py-2.5 text-sm text-ink focus:outline-none" />
              </div>
            </div>
          ...
          <div className="rounded-xl2 border border-line bg-surface p-6">
            ...
            <div className="mt-4 flex items-center justify-between border-b border-line pb-4">
              <div>
                ...
                <p className="text-xs text-ink-faint">Last changed 3 months ago</p>
              </div>
              <button className="rounded-lg border border-line px-3 py-2 text-xs font-medium text-ink hover:bg-canvas">Change password</button>
            </div>
            <div className="mt-4 flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-ink">Login sessions</p>
                <p className="text-xs text-ink-faint">2 active sessions</p>
              </div>
              <button className="rounded-lg border border-line px-3 py-2 text-xs font-medium text-ink hover:bg-canvas">Manage</button>
            </div>
          </div>
              ...
              {prefs.map(p => (
                <div key={p.id} className="flex items-center justify-between gap-4">
                  ...
                  <button 
                    ...
                    className={`relative h-6 w-11 shrink-0 rounded-full transition-colors ${p.on ? 'bg-lease-600' : 'bg-line'}`}
                  >
        ...
        <div className="h-fit rounded-xl2 border border-line bg-surface p-6">
          ...
          <button className="mt-4 w-full rounded-lg border border-line px-4 py-2.5 text-left text-sm font-medium text-ink hover:bg-canvas">Log out</button>
